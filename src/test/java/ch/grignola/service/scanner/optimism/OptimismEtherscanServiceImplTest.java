...
@QuarkusTest
class OptimismEtherscanServiceImplTest {
    ...
    @Inject
    OptimismScanService avalancheEtherscanService;
    ...
    void getEmptyAddressBalance() {
        List<ScannerTokenBalance> balance = avalancheEtherscanService.getAddressBalance(ADDRESS);
    ...
    void getSimpleAddressBalance() {
        ...
        List<ScannerTokenBalance> addressBalance = avalancheEtherscanService.getAddressBalance(ADDRESS);
    ...
    void getSimpleAddressBalanceWithBannedContract() {
        ...
        when(contractVerificationStatusRepository.findByNetwork(OPTIMISM))
        ...
        verify(restClient).getBalance(any(), any(), eq(ADDRESS));
        verify(restClient).getTokenEvents(any(), any(), eq(ADDRESS));
        verify(contractVerificationStatusRepository).findByNetwork(OPTIMISM);
