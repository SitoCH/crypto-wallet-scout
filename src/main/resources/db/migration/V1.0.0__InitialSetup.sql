create table BannedContract (id bigint not null auto_increment, contractId varchar(255), network varchar(255), primary key (id)) engine=InnoDB;
...
alter table Token add constraint UK_g7iijr4xu0wl5ybayswcw785o unique (symbol);
