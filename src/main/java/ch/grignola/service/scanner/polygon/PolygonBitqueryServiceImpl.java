...
@ApplicationScoped
public class PolygonBitqueryServiceImpl extends AbstractEthereumBitqueryScanService implements PolygonBitqueryService {

    public PolygonBitqueryServiceImpl() {
        super(POLYGON);
    }
